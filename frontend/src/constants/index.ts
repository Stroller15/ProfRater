...
export const perks = [
    {
        icon: Icons.auth,
        title: "Sign Up",
        info: "Create your free account to get started with ProfRater.",
    },
    {
        icon: Icons.customize,
        title: "Searching",
        info: "Choose a professor you want to know about.",
    },
    {
        icon: Icons.launch,
        title: "Information",
        info: "Get information about the searched professor.",
    },
];
